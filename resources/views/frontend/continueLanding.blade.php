        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 p-4">
                    ...
                    <center>
                        ...
                        <div id="confidenceScoreGauge"></div>
                        <canvas id="valGuage" style="height:300px; width:600px"></canvas>
                        @if(request()->get('part')==1)
                            <h3>Confidence Score</h3>
                        @elseif(request()->get('part')==2)
                            <h5>When valuing your business, our confidence in the<br>accuracy of our valuation was reduce by:</h5><br>
                            <div class=" row text-left pt-5">
                                ...
                                <div class="offset-md-4 col-md-4">
                                    ...
                                    <center><button  id="tellusmore" type="button" class="btn btn-primary btn-lg my-5"><h3 class="mb-0">TELL US MORE</h3></button></center>
                                </div>
    ...
    <div class="container-fluid px-0 my-5 ">
        @if(request()->get('part')==2)
            ...
            <div class="container my-5 pt-5">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-md-11">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 border border-primary border-right-0  border-top-0 border-bottom-0">
                                <br>
                                <h5 >Things you can be proud of</h5>
                                <br>
                                @foreach ($qsets["qa"] as $questions)
                ...
                <center>
                <a href=""  id="breakdown-sellbusiness" class="btn btn-primary btn-block" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/dealflowteam/fba-business-valuation-meeting-call'});return false;" style="max-width:300px">TELL US MORE</a>
                </center>
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Kevin has facilitated the sale and purchase of dozens of high value web assets through an increasingly large network of loyal clients. His success can be attributed to his deep understanding of 'the deal' and his dedication to achieving a result that is celebrated on boths sides.</p>
                                <button type="button" class="btn btn-outline-primary">WORK WITH KEVIN</button>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Calendly inline widget end -->
    <div class="container my-5">
        <P><b>* A 90-day time frame for closing is an estimate based on our experience on the current market conditions. How long it takes to sell a business always depends on a number of factor that we simply don't know, so your mileage may vary</b></P>
    </div>
