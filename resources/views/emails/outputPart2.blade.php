                 ...
                 <tr style="border-collapse:collapse">
                  <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:270px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                         <td>
                            Congratulations! Your business valuation is ${{number_format($transactionQAResult["valuationDollar"])}}
                            <br>
                            <br>
                            Schedule a call and pair up with our Sr. M&A advisors to get to know each other and be guided through the entire process until you receive the funds!
                            <br>
                            <br>
                            Pick your most convenient day and time through this <a href="https://calendly.com/dealflowteam/fba-business-valuation-meeting-call">link</a>.
                            <br>
                            <br>
